...
<head>
    ...
    <link rel="stylesheet" href="CSS3/estiloscabezera.css">
</head>
    ...
    <nav class="main-header">
        <div class="container">
            <ul class="sidebar">
                ...
                <li><a href="eleccion_sesion.PHP">Iniciar Sesion</a></li>
            </ul>
            <ul>
                <li id="logo-header">
                ...
                <li class="hideOnMobile"><a href="Comprar.PHP">Comprar</a></li>
                <li class="hideOnMobile"><a href="Carrito.PHP">Carrito</a></li>
                <li class="hideOnMobile"><a href="eleccion_sesion.PHP">Iniciar Sesion</a></li>
